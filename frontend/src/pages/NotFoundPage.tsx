...
export default function NotFoundPage() {
  return (
    <div className="flex flex-col items-center justify-center h-screen gap-4" style={{ background: '#f3efe7' }}>
      <div className="text-[80px]" style={{ fontFamily: "'Cormorant Garamond', serif", color: '#d6cfbf' }}>404</div>
      <h1 className="text-[28px]" style={{ fontFamily: "'Cormorant Garamond', serif", color: '#1a1614' }}>Page not found</h1>
