...
function OAuthButton({
  ...
  return (
    <button
      type="button"
      onClick={handleClick}
      className="flex items-center justify-center gap-2 w-full border rounded-lg px-4 py-2.5 text-sm font-medium transition-colors hover:bg-[#ebe6db] active:scale-[0.98]"
      style={{ borderColor: '#d6cfbf', color: '#3d342a', fontFamily: "'Crimson Pro', serif", fontSize: 15 }}
    >
      {icon}
      {label}
    </button>
